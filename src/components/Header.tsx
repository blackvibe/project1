      ...
      <header class="mx-auto max-w-screen-xl px-2 sm:px-6 mt-5 mb-5">
        ...
        <div class="float-right inline-block text-sm text-gray-600">
          <nav class="hidden md:inline-block leading-[48px]">
            <ul class="">
              <li class="inline">
                <A activeClass="!border-teal-600" class="hover:border-teal-600 border-b-2 pb-1 transition border-transparent" href="/info/about">
                  {t.header?.About} {JSON.stringify(user)}
                </A>
              </li>
              <li class="inline ml-5">
                <A activeClass="!border-teal-600" class="hover:border-teal-600 border-b-2 pb-1 transition border-transparent" href="/info/offer">
                  {t.header?.Offer}
                </A>
              </li>
              <li class="inline ml-5">
                <A activeClass="!border-teal-600" class="hover:border-teal-600 border-b-2 pb-1 transition border-transparent" href="/info/contacts">
                  {t.header?.Contacts}
                </A>
              </li>
              <li class="inline ml-5">
                <A activeClass="!border-teal-600" class="hover:border-teal-600 border-b-2 pb-1 transition border-transparent" href="/info/api">
                  {t.header?.api}
                </A>
              </li>
            </ul>
